...
/**
 * This is the item provider adapter for a {@link net.winklerweb.cdoxtext.example.graphix.Circle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CircleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphixPackage.Literals.CIRCLE__RADIUS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphixPackage.Literals.CIRCLE__CENTER,
				 false,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphixPackage.Literals.CIRCLE__CENTER);
		}
	...
	public String getText(Object object) {
		...
		if(circle.getCenter() == null) {
			return getString("_UI_Circle_type") + " at (undefinded) r=" + circle.getRadius();			
		}
		
		IItemLabelProvider centerLabelProvider = (IItemLabelProvider) adapterFactory.adapt(circle.getCenter(), IItemLabelProvider.class);
		return getString("_UI_Circle_type") + " at " + centerLabelProvider.getText(circle.getCenter()) + " r=" + circle.getRadius();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Circle.class)) {
			case GraphixPackage.CIRCLE__RADIUS:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case GraphixPackage.CIRCLE__CENTER:
