...
/**
 * This is the item provider adapter for a {@link net.winklerweb.cdoxtext.example.graphix.Color} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Color_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Color_name_feature", "_UI_Color_type"),
				 GraphixPackage.Literals.COLOR__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphixPackage.Literals.COLOR__RED,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphixPackage.Literals.COLOR__GREEN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphixPackage.Literals.COLOR__BLUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphixPackage.Literals.COLOR__ALPHA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Color.class)) {
			case GraphixPackage.COLOR__NAME:
			case GraphixPackage.COLOR__RED:
			case GraphixPackage.COLOR__GREEN:
			case GraphixPackage.COLOR__BLUE:
			case GraphixPackage.COLOR__ALPHA:
