...
/**
 * This is the item provider adapter for a {@link net.winklerweb.cdoxtext.example.graphix.Shape} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Shape_lineColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Shape_lineColor_feature", "_UI_Shape_type"),
				 GraphixPackage.Literals.SHAPE__LINE_COLOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addFillColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Shape_fillColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Shape_fillColor_feature", "_UI_Shape_type"),
				 GraphixPackage.Literals.SHAPE__FILL_COLOR,
				 true,
				 false,
				 true,
				 null,
