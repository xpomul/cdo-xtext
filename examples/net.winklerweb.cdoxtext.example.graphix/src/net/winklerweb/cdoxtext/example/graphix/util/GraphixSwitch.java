 ...
 * @generated
 */
public class GraphixSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GraphixPackage.SHAPE: {
				Shape shape = (Shape)theEObject;
				T result = caseShape(shape);
				if (result == null) result = caseGraphixElement(shape);
			...
			case GraphixPackage.CIRCLE: {
				...
				if (result == null) result = caseGraphixElement(circle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GraphixPackage.COLOR: {
				...
				if (result == null) result = caseGraphixElement(color);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GraphixPackage.GRAPHIX_CANVAS: {
				GraphixCanvas graphixCanvas = (GraphixCanvas)theEObject;
				T result = caseGraphixCanvas(graphixCanvas);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GraphixPackage.GRAPHIX_ELEMENT: {
				GraphixElement graphixElement = (GraphixElement)theEObject;
				T result = caseGraphixElement(graphixElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseGraphixCanvas(GraphixCanvas object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGraphixElement(GraphixElement object) {
		return null;
	}
